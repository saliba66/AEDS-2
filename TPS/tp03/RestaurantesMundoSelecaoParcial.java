...
class Hora {
    ...
    public static Hora parseHora(String s) {
        ...
        while (s.charAt(i) != ':') { // recebe string e passa para int
            h = h * 10 + (s.charAt(i) - '0');
            i++;
        }
...
public class RestaurantesMundoSelecaoParcial {

    static int comparacoes = 0;
    static int movimentacoes = 0;

// selecao parcial-------------------------------------------------------------------------------------------------------------
// o for externo roda só k vezes.


    public static void selecaoParcial(Restaurante[] array, int n) {
        int k = 10;
        ...
        for (int i = 0; i < k && i < n; i++) {
            ...
            for (int j = i + 1; j < n; j++) {
                ...
                // comparação entre elementos do array usando o nome
...
// main-------------------------------------------------------------------------------------------------------------
    ...
    public static void main(String[] args) throws Exception {
        ...
        FileWriter log = new FileWriter("885005_selecao parcial.txt");
