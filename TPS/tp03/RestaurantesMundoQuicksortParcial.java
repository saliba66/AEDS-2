...
class Data {
    ...
    public static Data parseData(String s) {
        ...
        while (s.charAt(i) != '-') {
            a = a * 10 + (s.charAt(i) - '0'); // transforma ano de String para int
            i++;
        }
        ...
        while (s.charAt(i) != '-') {
            m = m * 10 + (s.charAt(i) - '0'); // transforma mes de String para int
            i++;
        }
        ...
        while (i < s.length()) {
            d = d * 10 + (s.charAt(i) - '0'); // transforma dia de String para int
            i++;
        }
...
// swap-------------------------------------------------------------------------------------------------------------
// método auxiliar para trocar dois restaurantes de posição no array
...
// quicksort parcial-------------------------------------------------------------------------------------------------------------
// No parcial, só continuamos a recursão nas partes que podem afetar os 10 primeiros.
    ...
    public static void quicksortParcial(Restaurante[] array, int esq, int dir, int k) {
        ...
        // Ordena a parte esquerda, pois ela pode conter elementos dos 10 primeiros
        if (esq < j) {
            quicksortParcial(array, esq, j, k);
        }

        // Só ordena a direita se ela ainda puder influenciar as primeiras k posições
        if (i < dir && i < k) {
...
// main-------------------------------------------------------------------------------------------------------------
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (n > 0) {
            quicksortParcial(selecionados, 0, n - 1, 10);
        }
        ...
        // Arquivo de log, matrícula, comparações, movimentações e tempo 
        FileWriter log = new FileWriter("885005_quicksort parcial.txt");
