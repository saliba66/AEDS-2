...
class Restaurante {
    ...
    public static Restaurante parseRestaurante(String s) {
        ...
        if (abertoStr.length() >= 4 && abertoStr.charAt(0) == 't') {
            aberto = true;
        }
...
// ================= FILA =================
class FilaRestaurantes {
    private Restaurante[] array;
    private int primeiro;
    private int ultimo;
    private int n;

    public FilaRestaurantes() {
    ...
    public int mediaAnoAbertura() {
        ...
        for (int contador = 0; contador < n; contador++) {
            soma += array[i].getAnoAbertura();
            i = (i + 1) % 5;
        }

        return Math.round((float) soma / n);
    }
...
// ================= CLASSE PRINCIPAL =================
public class RestaurantesMundoListaCircular {
    public static void main(String[] args) throws Exception {
        Scanner scanner = new Scanner(System.in);
        ColecaoRestaurantes colecao = ColecaoRestaurantes.lerCsv();
        FilaRestaurantes fila = new FilaRestaurantes();
